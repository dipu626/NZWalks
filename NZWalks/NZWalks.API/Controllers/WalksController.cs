...
namespace NZWalks.API.Controllers
{
    ...
    public class WalksController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] string? filterOn, [FromQuery] string? filterQuery,
            ...
            [FromQuery] int pageNumber = 1, [FromQuery] int pageSize = (int)1E5)
        {
            List<Walk> walkDomainModel = await walkRepository.GetAllAsync(filterOn, filterQuery, sortBy, isAscending ?? true, pageNumber, pageSize);
